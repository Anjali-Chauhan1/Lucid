  ...
  return (
    <div className="mt-6">
      ...
      <button
        ...
        className="mt-4 w-full rounded-xl bg-violet px-6 py-3 text-sm font-semibold text-ink-900 transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
      >
        Start →
      </button>
    </div>
